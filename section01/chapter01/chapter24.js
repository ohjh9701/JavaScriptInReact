...
//2. 사용자가 날짜를 설정하는 방법
let date2 = new Date(1997,1-1,3,2,30,1);
let dateTime2 = date2.getTime();
console.log(date2);
console.log(dateTime2);

//3. 상대방에게 getTime() 주게되면, 날짜로 복구가능한가?
let date3 = new Date(dateTime2);
...
let milisecond = date4.getMilliseconds();
